package com.gabyferrari.send_book_email_spring_batch.step;
...
public class SendEmailUserStepConfig {
	...
	@Bean
	Step sendEmailUserStep(ItemReader<UserBookLoan> readUsersWithLoansCloseToReturnReader, JobRepository jobRepository) {
